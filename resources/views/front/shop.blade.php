                            ...
                            <div class="accordion accordion-flush" id="accordionExample">
                                ...
                                <div class="accordion-item">
                                    ...
                                    <h2 class="accordion-header" id="headingOne">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo-{{$key}}" aria-expanded="false" aria-controls="collapseTwo-{{$key}}">
                                            {{$category->name}}
                                        </button>
                                    </h2>
                                    @else
                                    ...
                                    @endif
                                    @if($category->sub_category->isNotEmpty())
                                    <div id="collapseTwo-{{$key}}" class="accordion-collapse collapse {{ ($categorySelected==$category->id) ? 'show':'' }}" aria-labelledby="headingOne" data-bs-parent="#accordionExample" style="">
                           ...
                           <div class="col-md-4">
                                <div class="card product-card">
                                    <div class="product-image position-relative">
                                        ...
                                        <img class="card-img-top" src="{{asset('productimages/'.$productimage->image)}}"/>    
                                        @else
                                        <img src="{{asset('admin-assets/img/default-150*150.png')}}"/>  
                                        @endif
                                        </a>
